            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        console.log()
                        return '<a class="me-2 btn btn-sm rounded-0 py-0 edit_data btn-primary" href="javascript:void(0)" data-id="' + (row.id) + '"> Ўзгартиши </a><a class="btn btn-sm rounded-0 py-0 delete_data btn-danger" href="javascript:void(0)" data-id="' + (row.id) + '"> Ўчириш </a>';
                    }
                }
            ],
                ...
                success: function(resp) {
                    if (!!resp.status) {
                        if (resp.status == 'success') {
                            ...
                            _el.text("Маълумотлар муваффақиятли сақланди!");
                ...
                success: function(resp) {
                    if (!!resp.status) {
                        if (resp.status == 'success') {
                            ...
                            _el.hide()
                            _el.addClass('alert alert-primary alert_msg')
                            _el.text("Маълумотлар муваффақиятли янгиланди!");
